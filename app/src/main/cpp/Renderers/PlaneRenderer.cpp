...
PlaneRenderer::PlaneRenderer(bool screen_baked)
    ...
    if(assetLoader::instance()->LoadTextFileFromAssetManager("shaders/plane.vert", &VERT_SHADER)
    &&assetLoader::instance()->LoadTextFileFromAssetManager("shaders/plane.frag", &FRAG_SHADER))
